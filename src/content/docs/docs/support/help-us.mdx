...
Do you see anything that is missing, please create an issue on the repository or just go ahead and create a pull request to the main branch, with suggested changes or updated documentation.
