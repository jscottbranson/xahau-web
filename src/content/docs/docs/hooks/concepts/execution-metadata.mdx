...
| sfHookEmitCount        | The total number of [Emitted Transactions]emitted-transactions produced by the Hook.                                                                    |
...
| sfHookStateChangeCount | The number of [Hook State]state-management changes the Hook made during execution.                                                                      |
