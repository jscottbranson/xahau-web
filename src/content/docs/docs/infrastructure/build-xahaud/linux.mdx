...
<Aside type="caution">
Creating an environment to build xahaud can cause permanent system damage. The [Build Environments](#build-environments) section of this page contains techniques for isolating your build environment from your underlying operating system. Undertake system changes at your own risk.
</Aside>
