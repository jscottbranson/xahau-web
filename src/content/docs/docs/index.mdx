...
The Protocol Reference section of Xahau's documentation provides an in-depth look at the platform's unique aspects, including various transaction types like CheckCancel, and Payment, each with its own specific use and characteristics.&#x20;
